...
<div class="flex flex-col items-start justify-start w-full h-full gap-6" data-emp-id="<?= $empID ?>" data-role="<?= $role ?>">
    <div class="flex flex-row items-end justify-between w-full h-auto">
        <div class="flex flex-col items-start justify-start w-auto h-auto gap-1">
            ...
            <p class="text-xs text-zinc-400 font-medium">Manage user accounts and permissions</p>
        </div>
    ...
    <div class="flex flex-col w-full flex-1 bg-white border border-zinc-200 rounded-xl overflow-hidden">
        ...
        <div class="grid grid-cols-12 items-center w-full h-auto px-5 py-3 bg-zinc-50 border-b border-zinc-200 gap-3">
            <p class="text-xs font-bold text-zinc-400 tracking-widest uppercase col-span-2">Employee ID</p>
            <p class="text-xs font-bold text-zinc-400 tracking-widest uppercase col-span-3">Name</p>
            <p class="text-xs font-bold text-zinc-400 tracking-widest uppercase col-span-4">Department</p>
            <p class="text-xs font-bold text-zinc-400 tracking-widest uppercase col-span-2">Role</p>
            <p class="text-xs font-bold text-zinc-400 tracking-widest uppercase text-right col-span-1">Actions</p>
        </div>
        ...
        <div id="users-table-body" class="flex flex-col w-full overflow-y-auto flex-1">
            ...
            <div id="users-table-empty" class="hidden flex-col items-center justify-center w-full py-16 gap-2">
                ...
                <p class="text-xs font-semibold text-zinc-400">No users found</p>
            </div>
        </div>
    </div>
...
<div id="add-user-modal" class="fixed inset-0 bg-black/40 backdrop-blur-sm hidden items-center justify-center z-50">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden" onclick="event.stopPropagation()">
        ...
        <div class="flex items-center justify-between bg-zinc-50 border-b border-zinc-200 px-6 py-4">
            <div>
                <h2 class="text-xs font-bold text-zinc-800">Add New User</h2>
        ...
        <div class="flex flex-col gap-4 px-6 py-5">
            ...
            <div class="flex flex-col gap-1.5 relative">
                <label class="text-xs font-bold text-zinc-400 tracking-wide uppercase">Search Employee (QC/QA/Sales Department) <span class="text-red-500">*</span></label>
                <div class="relative">
            ...
            <div id="selected-emp-info" class="hidden flex flex-col gap-2 bg-indigo-50 border border-indigo-200 rounded-lg px-4 py-3">
                ...
                <div class="flex items-center gap-3">
                    <p class="text-xs text-indigo-500 font-medium"><i class="fa-solid fa-id-badge text-[9px]"></i> <span id="selected-emp-id"></span></p>
                    <p class="text-xs text-indigo-500 font-medium"><i class="fa-solid fa-building text-[9px]"></i> <span id="selected-emp-dept"></span></p>
                </div>
            ...
            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-bold text-zinc-400 tracking-wide uppercase">Role <span class="text-red-500">*</span></label>
                ...
                <p id="role-hint" class="text-xs text-zinc-300 font-medium"></p>
            </div>
        </div>
